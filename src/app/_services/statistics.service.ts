...
export class StatisticsService {
  ...
  getSalesPersonAllVideosGroupedByJewelry(
    ...
    return this.http.get(
      `${environment.apiUrl}/statistics/getSalesPersonAllVideosGroupedByJewelry?userId=${userId}&from=${from}&to=${to}`
    );
  }

  getSalesPersonAllVideos(userId: number) {
    return this.http.get(
      `${environment.apiUrl}/statistics/getSalesPersonAllVideos?userId=${userId}`
    );
  }

  getSalesPersonVideosByDateRange(userId: number, from: string, to: string) {
    return this.http.get(
      `${environment.apiUrl}/statistics/getSalesPersonVideosByDateRange?userId=${userId}&from=${from}&to=${to}`
    );
  }
  // ****************
  // Stores API
  ...
  getStoreVideosByDate(
    ...
    return this.http.get(
      `${environment.apiUrl}/statistics/getStoreVideosByDate?manufacturerId=${manufacturerId}&storeId=${storeId}&from=${from}&to=${to}`
    );
  }
  getStoreVideosGroupByJewelry(
    ...
    return this.http.get(
      `${environment.apiUrl}/statistics/getStoreVideosGroupByJewelry?manufacturerId=${manufacturerId}&storeId=${storeId}&from=${from}&to=${to}`
    );
  }
  ...
  getJewelryByBarcodeAndDate(barcode: number, from: string, to: string) {
    return this.http.get(
      `${environment.apiUrl}/statistics/getJewelryByBarcodeAndDate?barcode=${barcode}&from=${from}&to=${to}`
    );
  }
